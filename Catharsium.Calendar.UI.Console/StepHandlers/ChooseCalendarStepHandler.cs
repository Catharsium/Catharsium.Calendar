...
public class ChooseCalendarStepHandler : IChooseCalendarStepHandler
{
    ...
    public async Task<External.GoogleCalendar.Client.Models.Calendar> Run() {
        ...
        return await Task.FromResult(null as External.GoogleCalendar.Client.Models.Calendar);
    }
}