...
public class ChooseCalendarStepHandlerTests : TestFixture<ChooseCalendarStepHandler>
{
    ...
    public async Task Run_WritesCalendars() {
        ...
        var calendars = new[] {
            new External.GoogleCalendar.Client.Models.Calendar {Summary = "My first calendar"},
            new External.GoogleCalendar.Client.Models.Calendar {Summary = "My second calendar"}
        };
